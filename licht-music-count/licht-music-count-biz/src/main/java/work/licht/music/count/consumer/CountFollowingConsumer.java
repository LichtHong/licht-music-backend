...
public class CountFollowingConsumer implements RocketMQListener<String> {
    ...
    public void onMessage(String body) {
        ...
        CountFollowUnfollowMqDTO countFollowUnfollowMqDTO = gson.fromJson(body, CountFollowUnfollowMqDTO.class);
        // 操作类型：关注 or 取关
        ...
        // 异步发送 MQ 消息
        rocketMQTemplate.asyncSend(RocketMQConstants.TOPIC_COUNT_FOLLOWING_2_DB, message, new SendCallback() {
            @Override
